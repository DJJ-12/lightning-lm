...
void MapEnuCalibrator::ClearSessionDataLocked() {
    ...
    main_gnss_received_ = main_gnss_valid_ = 0;
    slave_gnss_received_ = slave_gnss_valid_ = 0;
    ndt_received_ = ndt_valid_ = 0;
    rejected_time_sync_ = rejected_baseline_ = rejected_sampling_ = 0;
