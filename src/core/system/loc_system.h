...
class LocSystem {
   ...
   private:
    ...
    // 定位结果定时发布器
    rclcpp::TimerBase::SharedPtr ekf_timer_ = nullptr;
    rclcpp::CallbackGroup::SharedPtr imu_cb_group_ = nullptr;
    rclcpp::CallbackGroup::SharedPtr lidar_cb_group_ = nullptr;
    rclcpp::CallbackGroup::SharedPtr ekf_timer_cb_group_ = nullptr;

    std::string imu_topic_;
    std::string cloud_topic_;
    std::string livox_topic_;
    std::string wheel_odom_topic_;
    int ekf_timer_period_ms_ = 100;

    rclcpp::Subscription<sensor_msgs::msg::Imu>::SharedPtr imu_sub_ = nullptr;
    rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr cloud_sub_ = nullptr;
    rclcpp::Subscription<livox_ros_driver2::msg::CustomMsg>::SharedPtr livox_sub_ = nullptr;
    rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr wheel_odom_sub_ = nullptr;
