...
#include "lightning_interfaces/srv/get_map_enu_calibration_status.hpp"
...
#include "lightning_interfaces/srv/finish_map_enu_calibration.hpp"
...
#include "lightning_interfaces/srv/start_map_enu_calibration.hpp"
...
class Service {
   ...
   private:
    ...
    rclcpp::Service<lightning_interfaces::srv::StartMapEnuCalibration>::SharedPtr
        start_map_enu_calibration_srv_;
    rclcpp::Service<lightning_interfaces::srv::GetMapEnuCalibrationStatus>::SharedPtr
        get_map_enu_calibration_status_srv_;
    rclcpp::Service<lightning_interfaces::srv::FinishMapEnuCalibration>::SharedPtr
